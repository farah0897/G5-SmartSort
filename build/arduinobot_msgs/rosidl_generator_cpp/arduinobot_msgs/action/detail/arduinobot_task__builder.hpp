...
class Init_ArduinobotTask_Goal_gripper_state
{
public:
  explicit Init_ArduinobotTask_Goal_gripper_state(::arduinobot_msgs::action::ArduinobotTask_Goal & msg)
  : msg_(msg)
  {}
  ::arduinobot_msgs::action::ArduinobotTask_Goal gripper_state(::arduinobot_msgs::action::ArduinobotTask_Goal::_gripper_state_type arg)
  {
...
class Init_ArduinobotTask_Goal_joint_positions
{
public:
  explicit Init_ArduinobotTask_Goal_joint_positions(::arduinobot_msgs::action::ArduinobotTask_Goal & msg)
  : msg_(msg)
  {}
  Init_ArduinobotTask_Goal_gripper_state joint_positions(::arduinobot_msgs::action::ArduinobotTask_Goal::_joint_positions_type arg)
  {
    msg_.joint_positions = std::move(arg);
    return Init_ArduinobotTask_Goal_gripper_state(msg_);
  }
...
public:
  ...
  {}
  Init_ArduinobotTask_Goal_joint_positions task_number(::arduinobot_msgs::action::ArduinobotTask_Goal::_task_number_type arg)
  {
    msg_.task_number = std::move(arg);
    return Init_ArduinobotTask_Goal_joint_positions(msg_);
  }
...
class Init_ArduinobotTask_Result_message
{
public:
  explicit Init_ArduinobotTask_Result_message(::arduinobot_msgs::action::ArduinobotTask_Result & msg)
  : msg_(msg)
  {}
  ::arduinobot_msgs::action::ArduinobotTask_Result message(::arduinobot_msgs::action::ArduinobotTask_Result::_message_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_ArduinobotTask_Result_message success(::arduinobot_msgs::action::ArduinobotTask_Result::_success_type arg)
  {
    msg_.success = std::move(arg);
    return Init_ArduinobotTask_Result_message(msg_);
  }
...
class Init_ArduinobotTask_Feedback_current_state
{
public:
  explicit Init_ArduinobotTask_Feedback_current_state(::arduinobot_msgs::action::ArduinobotTask_Feedback & msg)
  : msg_(msg)
  {}
  ::arduinobot_msgs::action::ArduinobotTask_Feedback current_state(::arduinobot_msgs::action::ArduinobotTask_Feedback::_current_state_type arg)
  {
...
class Init_ArduinobotTask_Feedback_completion_percentage
{
public:
  Init_ArduinobotTask_Feedback_completion_percentage()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_ArduinobotTask_Feedback_current_state completion_percentage(::arduinobot_msgs::action::ArduinobotTask_Feedback::_completion_percentage_type arg)
  {
    msg_.completion_percentage = std::move(arg);
    return Init_ArduinobotTask_Feedback_current_state(msg_);
  }
...
{
  return arduinobot_msgs::action::builder::Init_ArduinobotTask_Feedback_completion_percentage();
}
