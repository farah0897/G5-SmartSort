...
// class of simple parameter node
...
public:
    SimpleParameter() : Node("simple_parameter")
    {
        ...
        declare_parameter<std::string>("simple_string_param", "farah");
...
int main(int argc, char* argv[])
{
    ...
    auto simple_parameter_node = std::make_shared<SimpleParameter>();
    rclcpp::spin(simple_parameter_node);
    rclcpp::shutdown();
    return 0;
}